                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="POST" enctype="multipart/form-data" @submit.prevent="submitData">
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full lg:w-1/3 px-4">
                                    <div class="relative w-full mb-3">
                                        <avatar-upload class="h-40 w-40 rounded-full overflow-hidden" v-model="form.logo"></avatar-upload>
                            ...
                            <div class="items-center">
                                <button :disabled="form.processing" class = "mt-3 bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 font-bold rounded hover:shadow-lg transition duration-200 w-full">Add Client</button>
                            </div>
                        </form>
                    </div>
                </div>
