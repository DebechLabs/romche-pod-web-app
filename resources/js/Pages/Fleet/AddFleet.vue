                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="POST" enctype="multipart/form-data" @submit.prevent="submitData">
                            ...
                            <div class="items-center">
                                <button :disabled="form.processing" class = "mt-3 bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 font-bold rounded hover:shadow-lg transition duration-200 w-full">Add Vehicle</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        submitData: function(){
            this.form.post(`${this.$routes('fleet.store')}`)
        }
    }
}
</script>
